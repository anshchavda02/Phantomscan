...
printf '\033[1;36mPhantomScan 2.2.0 macOS CLI Installer\033[0m\n'
...
if command -v go >/dev/null 2>&1; then
  ...
  printf '\033[33m[skip]\033[0m go compiler not found. Install with: brew install go\n'
fi
...
if command -v cargo >/dev/null 2>&1; then
  ...
  printf '\033[33m[skip]\033[0m cargo compiler not found. Install with: brew install rust\n'
fi
...
if command -v npm >/dev/null 2>&1; then
  ...
  printf '\033[33m[skip]\033[0m npm/node not found. Install with: brew install node\n'
fi
...
printf 'If not already in your PATH, add to ~/.zshrc or ~/.bash_profile:\n'
